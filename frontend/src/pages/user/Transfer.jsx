  ...
  return (
    <div>
      <PageHeader
        ...
        title="Send money"
        subtitle="Transfer to any other GigCredit user by email. The backend verifies the recipient and updates both wallets atomically."
          ...
          <form onSubmit={submit}>
            <div className="field">
              ...
              <input
                ...
                required autoFocus
              />
              <span className="tiny muted">The recipient must be an active GigCredit user.</span>
            </div>
            <div className="field">
              <label>Amount</label>
              <input
